...
const Footer = () => {
  return (
    <>
      <div className="bg-[#FCEED5] h-auto rounded-t-2xl">
        <div className="flex items-center justify-center p-8 gap-5">
          <div className="bg-[#003459] w-[1440px] h-auto rounded-2xl mt-20">
            <div className="flex gap-5 p-8">
              <h1 className="font-bold leading-9 capitalize text-2xl text-white">
                Register now so you don't miss our programs
              </h1>

              <div className="w-[1400px] p-4] bg-white rounded-2xl inline-flex">
                <div className="flex items-center justify-center p-3 gap-7">
                  <input
                    type="text"
                    className="w-[750px] h-10 p-3 outline-none"
                    placeholder="Enter your Email"
                  />
                  <button
                    style={{ padding: "14px 28px 10px 28px" }}
                    className="bg-[#003459] text-white inline-flex justify-center items-center rounded-2xl"
                  >
                    Subcribe Now
                  </button>
                </div>
        ...
        <div className="flex items-center justify-center p-8 gap-5">
          <div className="bg-transparent w-[1440px] h-auto rounded-2xl">
            <div className="flex justify-between">
              <div className="flex gap-8">
                <span className="cursor-pointer transition duration-300 ease-in-out hover:scale-110 hover:underline">
                  Home
                </span>
                <span className="cursor-pointer transition duration-300 ease-in-out hover:scale-110 hover:underline">
                  Category
        ...
        <div className="flex items-center justify-center p-8 gap-5">
          <div className="bg-transparent w-[1440px] h-auto rounded-2xl">
            <div className="flex justify-between items-center">
              <div className="text-[#667479] text-sm leading-5 font-medium">
              ...
              <div className="text-[#667479] text-sm leading-5 font-medium flex gap-3">
